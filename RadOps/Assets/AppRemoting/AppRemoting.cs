...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    public class AppRemoting : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            string commonMessage = "Welcome to the NAME OF PROJECT mixed reality dashboard for streaming. Provide an IP address from your Holographic Remoting Player and click \"Connect\". \nEnsure that the Hololens and the streaming computer are connected to the same network.";
